...
export const MENU_BOOKS_AND_CHAPTERS = 'books-and-chapters';
export const MENU_VERSE_OF_THE_DAY = 'verse-of-the-day';
...
export const SPIRITUAL_GUIDANCE_VERSES = [
	{
		description: "Afraid",
		verses: [
			"PSA.34.4",
	...
	{
		description: "Regressing to Old and Bad Habits",
		verses: [
			"1JN.1.4-1JN.1.9"
		]
	},
	...
	{
		description: "Feeling Dread of Disasters",
		verses: [
			"PSA.118.5-PSA.118.6",
			"LUK.8.22-LUK.8.25"
		]
	...
	{
		description: "Doubting your Faith",
		verses: [
			"MAT.8.26",
			"PSA.42.5"
		]
	...
	{
		description: "Having Friends Who Failed You",
		verses: [
			"PSA.41.9-PSA.41.13",
			"LUK.17.3-LUK.17.4",
			"ROM.12.14-ROM.12.21",
	...
	{
		description: "Lonely and Depressed",
		verses: [
			"HEB.13.5-HEB.13.6"
		]
	},
	{
		description: "Needing God’s Protection",
		verses: [
			"PSA.27.1-PSA.27.6",
			"PHP.4.19"
		]
